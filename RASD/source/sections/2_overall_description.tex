...
\begin{itemize}
    ...
    \item D4: Users consent to enable and share their GPS location to the BBP *specify that otherwise some main functionalities of the BBP system will not be available 
