...
\begin{itemize}
    \item R20: The system shall notify registered users with planned trips when relevant weather conditions affecting the trip exceed a predefined severity threshold \footnote{The system alerts the registered user of a relevant weather condition along a planned trip only when the external weather service provides an adverse forecast.}.
    \item R21: The system shall notify registered users with planned trips when obstacles along the associated path exceed a predefined severity threshold \footnote{The system alerts the registered user of a given obstacle along a planned trip only when other registered users report an obstacle with a high severity (a combination of temperature, wind speed and humidity).}.
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.25\textwidth}|p{0.75\textwidth}|}
        ...
        \hline
    \end{tabular}
    \caption{UC3: Update Profile Data}
    \label{uc3}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.25\textwidth}|p{0.75\textwidth}|}
        ...
        \hline
    \end{tabular}
    \caption{UC7: Change Automatic Tracking Settings}
    \label{uc7}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.25\textwidth}|p{0.75\textwidth}|}
        ...
        \hline
    \end{tabular}
    \caption{UC8: View History and Statistics of Completed Trips}
    \label{uc8}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.25\textwidth}|p{0.75\textwidth}|}
        ...
        \hline
    \end{tabular}
    \caption{UC9: Delete Trips from History}
    \label{uc9}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.25\textwidth}|p{0.75\textwidth}|}
        ...
        \hline
    \end{tabular}
    \caption{UC12: Receive Trip Alerts}
    \label{uc12}
\end{table}
...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{|X|X|}
        \hline
        \multicolumn{2}{|l|}{G1: Registered Users are able to keep track of their cycling activities over time.}  \\ \hline
        \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
            \item R10: The system shall allow registered users to record their trips.
            \item R11: The system shall provide registered users with statistics about their cycling performance.
            \item R12: The system shall allow registered users to view all the non deleted past trips.
            \item R13: The system shall allow registered users to delete trips from their trip history.
        \end{itemize} & \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
            \item D2: Users’ devices have accelerometer and gyroscope sensors.
            \item D3: Data gathered from devices’ sensors is accurate.
            \item D4: Users consent to enable and share their GPS location.
        \end{itemize} \\ \hline
    \end{tabularx}
    \caption{Requirement Mapping of Goal G1.}
    \label{tab:rm_g1}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \multicolumn{2}{|p{0.95\textwidth}|}{G2: Information about bike paths is continuously enriched based on registered users’ cycling activities and reports.} \\ \hline
    \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
        \item R14: The system shall allow registered users to enable or disable automatic trip tracking.
        \item R15: The system shall allow registered users to manually produce a report.
        \item R16: The system shall allow registered users to automatically produce a report.
        ...
        \item R19: The system shall allow registered users to publish validated reports produced automatically.
    \end{itemize} & \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
        \item D1: Users aim to provide truthful and accurate information when reporting.
        \item D2: Users’ devices have accelerometer and gyroscope sensors.
        \item D3: Data gathered from devices’ sensors is accurate.
        \item D4: Users consent to enable and share their GPS location.
        \item D10: A sufficient number of users actively contribute reports.
    \end{itemize} \\ \hline
    \end{tabularx}
    \caption{Requirement Mapping of Goal G2.}
    \label{tab:rm_g2}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \multicolumn{2}{|p{0.95\textwidth}|}{G3: Automatically collected information about bike paths is validated by registered users before being made public.} \\ \hline
    \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
        \item R16: The system shall allow registered users to automatically produce a report.
        \item R17: The system shall allow registered users to review and validate reports produced automatically.
        \item R19: The system shall allow registered users to publish validated reports produced automatically.
    ...
    \end{itemize} \\ \hline
    \end{tabularx}
    \caption{Requirement Mapping of Goal G3.}
    \label{tab:rm_g3}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \multicolumn{2}{|p{0.95\textwidth}|}{G4: Registered users are provided with statistics about their cycling performance.} \\ \hline
    \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
        \item R11: The system shall provide registered users with statistics about their cycling performance.
        \item R14: The system shall allow registered users to enable or disable automatic trip tracking.
    \end{itemize} & \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
    ...
    \end{itemize} \\ \hline
    \end{tabularx}
    \caption{Requirement Mapping of Goal G4.}
    \label{tab:rm_g4}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \multicolumn{2}{|p{0.95\textwidth}|}{G5: Trip data is enriched with meteorological information.}  \\ \hline
    \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
    ...
    \end{itemize} & \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
        \item D8: The external weather service reliably responds to requests.
        \item D9: The meteorological information gathered is accurate.
    \end{itemize} \\ \hline
    \end{tabularx}
    \caption{Requirement Mapping of Goal G5.}
    \label{tab:rm_g5}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \multicolumn{2}{|p{0.95\textwidth}|}{G6: Bike path information is accessible to both registered and unregistered users.} \\ \hline
    \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
        \item R5: The system shall allow users to browse the inventory of paths.
        \item R6: The system shall allow users to visualise available bike paths on a map provided by an external map service.
        \item R8: The system shall allow the user to specify a starting and ending point in order to retrieve all the possible path between them.
        \item R9: In case a user has provided a departure and a destination point, the system shall return the possible paths ordered based on their scores.
    \end{itemize} & \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
        \item D6: The external map service reliably responds with geographical data.
        \item D7: The geographical information gathered from the external map service is accurate.
    \end{itemize} \\ \hline
    \end{tabularx}
    \caption{Requirement Mapping of Goal G6.}
    \label{tab:rm_g6}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|X|X|}
    \hline
    \multicolumn{2}{|p{0.95\textwidth}|}{G7: Users are supported in selecting suitable bike paths. } \\ \hline
    \begin{itemize}[topsep=0pt, partopsep=0pt, leftmargin=*]
        \item R5: The system shall allow users to browse the inventory of paths.
        \item R6: The system shall allow users to visualise available bike paths on a map. 
        \item R8: The system shall allow the user to specify a starting and ending point to retrieve possible paths.
        \item R9: The system shall return the possible paths ordered based on their scores.
    ...
    \end{itemize} \\ \hline
    \end{tabularx}
    \caption{Requirement Mapping of Goal G7.}
    \label{tab:rm_g7}
\end{table}
