...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{RASD//source//images//diagrams/sd_trip_details.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{RASD//source//images//diagrams/sd_automatic_report.png}
    \caption{Manual Report Sequence Diagram.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{RASD//source//images//diagrams/sd_trip_alert.png}
