...
\begin{itemize}
    ...
    \item SP9: Registered users plan a biking trip, causing the trip to be stored and managed by the system.
    \item SP10: Registered users accept the automatic tracking of the system.
    \item SP11: Registered users' devices share GPS data and other relevant sensor measurements to the system.
    \item SP12: Registered users update their profile information
    \item SP13: Registered users delete their account from the system
    \item SP14: Registered users delete trips from their trip history
    \item SP15:Registered users request access to their stored trip history.
    \item SP16: Users specify departure and destination points for route planning.
...
\begin{itemize}
    \item SP17: The system provides suggested bike paths between the selected departure and destination points.
    \item SP18: The system sends requests to an external service to query weather information.
    \item SP19: The system sends requests to an external service to query map data.
    \item SP20: The system informs users about the presence of obstacles along a path associated with a planned trip
    \item SP21: The system informs users about adverse weather in the location of the planned trip
\end{itemize}
