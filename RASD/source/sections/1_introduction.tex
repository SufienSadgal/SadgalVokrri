...
\begin{itemize}
    ...
    \item SP13: The system sends requests to an external service to query weather information.
    \item SP14: The system sends requests to an external service to query map data.
    \item SP15: The system informs users about the presence of obstacles along a path.
\end{itemize}
