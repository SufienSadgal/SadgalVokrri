...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{DD/source/images/UI/SignIn Screen.png}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{DD/source/images/UI/SignUp Screen.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{DD/source/images/UI/Home Screen.png}
        \caption{Home Screen.}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{DD/source/images/UI/Trip Details Screen.png}
        \caption{Sign Up Screen.}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{DD/source/images/UI/Trip Details Screen - Deletion.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{DD/source/images/UI/Map Screen.png}
        \caption{Map Screen.}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{DD/source/images/UI/Map Screen - Trip Planning 1.png}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{DD/source/images/UI/Map Screen - Trip Planning 2.png}
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=0.5\textwidth]{DD/source/images/UI/Navigation.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{DD/source/images/UI/Report Screen.png}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{DD/source/images/UI/Report Screen - Add obstacle.png}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \includegraphics[width=0.75\textwidth]{DD/source/images/UI/Congrats Screen.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.25\linewidth]{DD/source/images/UI/Profile Screen.png}
...
2. Bike Path Discovery and Visualisation
(FR: R5–R6)
Componenti coinvolti
1) Web/Mobile Client
2) API Gateway / Backend API
4) Path Exploration Service
5) Map & Weather Integration
13) Persistence Store
14) External Map Service

3. Trip Planning and Route Recommendation
(FR: R7–R9)
Componenti coinvolti
1) Web/Mobile Client
2) API Gateway / Backend API
...
4. Trip Tracking, History and Performance Analytics
(FR: R10–R14)
Componenti coinvolti
1) Web/Mobile Client
2) API Gateway / Backend API
...
9) Tracking Ingestion Endpoint
10) Tracking Processing Worker
13) Persistence Store
16) User Device (Sensors/GPS)
User Management Component



5. Reporting, Validation and Publication of Path Information
(FR: R15–R19)
Componenti coinvolti
1) Web/Mobile Client
2) API Gateway / Backend API
7) Reporting
8) Event Bus / Message Queue
11) Auto Report Generator Worker
13) Persistence Store

6. Context Enrichment and Notifications
(FR: R20–R22)
Componenti coinvolti
2) API Gateway / Backend API
5) Map & Weather Integration
8) Event Bus / Message Queue
12) Alert Evaluation Worker
13) Persistence Store
15) External Weather Service