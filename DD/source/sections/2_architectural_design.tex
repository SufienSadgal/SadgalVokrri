...
The Reporting component manages both manual and automatic reports as domain entities. In particular it allows publication of reports and validation of automatic report drafts (created by component 12) and UPDATES PUBLIC PATH INFORMATION BASED ON THE NEWLY PUBLISHED REPORTS, these updates are used to enrich path exploration results and to trigger alert evaluations. (In other words a user publishes “hole at path with ID 12,” then the reporting component updates the information regarding path 12 in the database so that the path exploration service component can then display the correct information).
